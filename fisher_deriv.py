...
for i in range(len(hold)):
    a2.append(((cov[comb[i][0]][comb[i][0]]+cov[comb[i][1]][comb[i][1]])/2.)+np.sqrt((np.square(cov[comb[i][0]][comb[i][0]]-cov[comb[i][1]][comb[i][\
1]])/4.)+np.square(cov[comb[i][0]][comb[i][1]])))
    b2.append(((cov[comb[i][0]][comb[i][0]]+cov[comb[i][1]][comb[i][1]])/2.)-np.sqrt((np.square(cov[comb[i][0]][comb[i][0]]-cov[comb[i][1]][comb[i][\
1]])/4.)+np.square(cov[comb[i][0]][comb[i][1]])))
