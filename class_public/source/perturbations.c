...
int perturb_init(
  ...
  class_test((ppt->gauge == synchronous) && (pba->has_cdm == _FALSE_) && (pba->has_dbk == _FALSE_) && (pba->has_dmeff == _FALSE_),
             ppt->error_message,
...
int perturb_indices_of_perturbs(
  ...
  ppt->has_source_delta_dbk = _FALSE_;
  ...
  ppt->has_source_theta_dbk = _FALSE_;
  ...
  for (index_md = 0; index_md < ppt->md_size; index_md++) {
    ...
    if (_scalars_) {
      ...
      if (ppt->has_density_transfers == _TRUE_) {
        ...
        if (pba->has_dbk == _TRUE_)
          ppt->has_source_delta_dbk = _TRUE_;
      ...
      if (ppt->has_velocity_transfers == _TRUE_) {
        ...
        if (pba->has_dbk == _TRUE_)
          ppt->has_source_theta_dbk = _TRUE_;
        if (pba->has_dmeff == _TRUE_)
      ...
      class_define_index(ppt->index_tp_delta_dbk,  ppt->has_source_delta_dbk, index_type,1);
      ...
      class_define_index(ppt->index_tp_theta_dbk,  ppt->has_source_theta_dbk, index_type,1);
...
int perturb_prepare_output(struct background * pba,
  ...
  if (ppt->k_output_values_num > 0) {
    ...
    if (ppt->has_scalars == _TRUE_){
      ...
      class_store_columntitle(ppt->scalar_titles,"delta_dbk",pba->has_dbk);
      class_store_columntitle(ppt->scalar_titles,"delta_dmeff",pba->has_dmeff);
      class_store_columntitle(ppt->scalar_titles,"theta_dbk",pba->has_dbk);
...
int perturb_vector_init(
  ...
  if (_scalars_) {
    ...
    class_define_index(ppv->index_pt_delta_dbk,pba->has_dbk,index_pt,1); /* cdm density */
    class_define_index(ppv->index_pt_theta_dbk,pba->has_dbk,index_pt,1);
  ...
  /** - case of switching approximation while a wavenumber is being integrated */
    ...
    if (_scalars_) {
      ...
      if (pba->has_dbk == _TRUE_) {
        ...
        ppv->y[ppv->index_pt_delta_dbk] =
          ppw->pv->y[ppw->pv->index_pt_delta_dbk];

        ppv->y[ppv->index_pt_theta_dbk] =
          ppw->pv->y[ppw->pv->index_pt_theta_dbk];
...
int perturb_initial_conditions(struct precision * ppr,
  ...
  double delta_ur=0.,theta_ur=0.,shear_ur=0.,l3_ur=0.,eta=0.,delta_cdm=0.,delta_dbk=0.,delta_dmeff=0.,alpha, alpha_prime;
  double delta_dr=0;
  double q,epsilon,k2;
  ...
  if (_scalars_) {
    ...
    if (pba->has_dbk == _TRUE_) {
      rho_m += ppw->pvecback[pba->index_bg_rho_dbk];
    }
    ...
    */
    ...
    if ((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad)) {
      ...
      if (pba->has_dbk == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_dbk] = 3./4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* dbk density */
        ppw->pv->y[ppw->pv->index_pt_theta_dbk] = ppw->pv->y[ppw->pv->index_pt_theta_g]; /* dbk velocity */
      }
    ...
    if ((ppt->has_cdi == _TRUE_) && (index_ic == ppt->index_ic_cdi)) {
      ...
      class_test(pba->has_cdm == _FALSE_ && pba->has_dbk == _FALSE_ && pba->has_dmeff == _FALSE_,
                 ppt->error_message,
      ...
      ppw->pv->y[ppw->pv->index_pt_delta_dbk] = ppr->entropy_ini+3./4.*ppw->pv->y[ppw->pv->index_pt_delta_g];
    ...
    if ((ppt->has_bi == _TRUE_) && (index_ic == ppt->index_ic_bi)) {
      ...
      if (pba->has_dbk == _TRUE_) {
        ...
        ppw->pv->y[ppw->pv->index_pt_delta_dbk] = 3./4.*ppw->pv->y[ppw->pv->index_pt_delta_g];
    ...
    if ((ppt->has_nid == _TRUE_) && (index_ic == ppt->index_ic_nid)) {
      ...
      if (pba->has_dbk == _TRUE_) {
        ...
        ppw->pv->y[ppw->pv->index_pt_delta_dbk] = -ppr->entropy_ini*fracnu*fracb/fracg/80.*ktau_two*om*tau;
    ...
    if ((ppt->has_niv == _TRUE_) && (index_ic == ppt->index_ic_niv)) {
      ...
      if (pba->has_dbk == _TRUE_) {
        ...
        ppw->pv->y[ppw->pv->index_pt_delta_dbk] = -ppr->entropy_ini*9./64.*fracnu*fracb/fracg*k*tau*om*tau;
    ...
    if (ppt->gauge == newtonian) {
      ...
      */
      ...
      else if (pba->has_dbk == _TRUE_)
        delta_cdm = ppw->pv->y[ppw->pv->index_pt_delta_dbk];
      ...
      if (pba->has_dbk == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_dbk] -= 3.*a_prime_over_a*alpha;
        ppw->pv->y[ppw->pv->index_pt_theta_dbk] = k*k*alpha;
      }
...
int perturb_total_stress_energy(
  ...
  if (_scalars_) {
    ...
    /* dbk contribution */
    if (pba->has_dbk == _TRUE_) {
      ppw->delta_rho += ppw->pvecback[pba->index_bg_rho_dbk]*y[ppw->pv->index_pt_delta_dbk];
      ppw->rho_plus_p_theta += ppw->pvecback[pba->index_bg_rho_dbk]*y[ppw->pv->index_pt_theta_dbk];
    }
    ...
    */
    ...
    if (ppt->has_source_delta_m == _TRUE_) {
      ...
      if (pba->has_dbk == _TRUE_) {
        delta_rho_m += ppw->pvecback[pba->index_bg_rho_dbk]*y[ppw->pv->index_pt_delta_dbk];
        rho_m += ppw->pvecback[pba->index_bg_rho_dbk];
      }
    ...
    if ((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_)) {
      ...
      if (pba->has_dbk == _TRUE_) {
        rho_plus_p_theta_m += ppw->pvecback[pba->index_bg_rho_dbk]*y[ppw->pv->index_pt_theta_dbk];
        rho_plus_p_m += ppw->pvecback[pba->index_bg_rho_dbk];
      }
...
int perturb_sources(
  ...
  if (_scalars_) {
    ...
    if (ppt->has_source_delta_cdm == _TRUE_) {
     ...
     /* delta_dbk */
    if (ppt->has_source_delta_dbk == _TRUE_) {
      _set_source_(ppt->index_tp_delta_dbk) = y[ppw->pv->index_pt_delta_dbk];
    }
    ...
    /* theta_dbk */
    if (ppt->has_source_theta_dbk == _TRUE_) {
      _set_source_(ppt->index_tp_theta_dbk) = y[ppw->pv->index_pt_theta_dbk];
    }
...
int perturb_print_variables(double tau,
  ...
  double delta_dbk=0.,theta_dbk=0.;
  ...
  if (_scalars_) {
    ...
    if (pba->has_dbk == _TRUE_) {
      ...
      delta_dbk = y[ppw->pv->index_pt_delta_dbk];
      theta_dbk = y[ppw->pv->index_pt_theta_dbk];
    ...
    if (ppt->gauge == synchronous) {
      ...
      if (pba->has_dbk == _TRUE_) {
        delta_dbk -= 3. * pvecback[pba->index_bg_H]*pvecback[pba->index_bg_a]*alpha;
        theta_dbk += k*k*alpha;
      }
    ...
    /* Dark matter with effective interactions */
    class_store_double(dataptr, delta_dbk, pba->has_dbk, storeidx);
    class_store_double(dataptr, theta_dbk, pba->has_dbk, storeidx);
    /* Dark matter with effective interactions */
...
int perturb_derivs(double tau,
  ...
  /* for use with dbk */
  double R_dbk, beta_dbk, beta=0., slip;
  /* for use with dmeff */
  double R_dmeff, beta_dmeff;
  ...
  if (pba->has_dbk == _TRUE_)
    R_dbk = pvecback[pba->index_bg_rho_dbk]/pvecback[pba->index_bg_rho_b];
  if (pba->has_dmeff == _TRUE_)
  ...
  if (_scalars_) {
    ...
    if (pba->has_dbk == _TRUE_) {
      ...
      /** ---> newtonian gauge: dbk density and velocity */

      if (ppt->gauge == newtonian) {
        dy[pv->index_pt_delta_dbk] = -(y[pv->index_pt_theta_dbk]+metric_continuity); /* dbk density */

        dy[pv->index_pt_theta_dbk] = - a_prime_over_a*y[pv->index_pt_theta_dbk] + metric_euler; /* dbk velocity */
      }

      /** ---> synchronous gauge: dbk density and velocity */

      if (ppt->gauge == synchronous) {
        dy[pv->index_pt_delta_dbk] = -(y[pv->index_pt_theta_dbk]+metric_continuity); /* dbk density */
        dy[pv->index_pt_theta_dbk] =
          - a_prime_over_a*y[pv->index_pt_theta_dbk] + metric_euler
          + k2*pvecback[pba->index_bg_cdbk2]*(y[pv->index_pt_delta_dbk])
          + pvecback[pba->index_bg_dkappa_dbk]*(theta_b - y[pv->index_pt_theta_dbk]); /* dbk velocity */
      }

      beta_dbk = (pvecback[pba->index_bg_dkappa_dbk]/pvecthermo[pth->index_th_dkappa]) * R_dbk / (1. + R);
    }
    ...
    if (ppw->approx[ppw->index_ap_tca] == (int)tca_off) {
      ...
      /** contributions from interactions with dark matter (dbk) **/
      if (pba->has_dbk == _TRUE_){
        dy[pv->index_pt_theta_b] += R_dbk*pvecback[pba->index_bg_dkappa_dbk]*(y[pv->index_pt_theta_dbk]-theta_b);
      }
      ...
      if(pba->has_dbk==_TRUE_){
        beta += beta_dbk;
        slip += beta_dbk*(dy[pv->index_pt_theta_dbk]-a_prime_over_a/2.*(y[pv->index_pt_theta_dbk]-theta_b));
        //printf("k=%f; z=%f;  beta_dbk=%f  R_dbk=%f\n",k,z,beta_dbk,R_dbk);
      }
      ...
      if(pba->has_dmeff==_TRUE_){
        ...
        //printf("k=%f; z=%f;  beta_dmeff=%f  R_dmeff=%f\n",k,z,beta_dmeff,R_dmeff);
      }
    ...
    if (ppw->approx[ppw->index_ap_rsa] == (int)rsa_off) {
      ...
      /** - ----> if photon tight-coupling is on: */
        ...
        if (pba->has_dbk == _TRUE_)
          dy[pv->index_pt_theta_g] += pvecback[pba->index_bg_dkappa_dbk]*R_dbk/R * (y[pv->index_pt_theta_dbk]-theta_b);
        if (pba->has_dmeff == _TRUE_)
          dy[pv->index_pt_theta_g] += pvecback[pba->index_bg_dkappa_dmeff]*R_dmeff/R * (y[pv->index_pt_theta_dmeff]-theta_b);
