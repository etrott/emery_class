...
struct spectra {
  ...
  int index_tr_delta_dbk;      /**< index of dark matter with effective interactions density transfer function */
  ...
  int index_tr_theta_dbk;      /**< index of dark matter with effective interactions velocity transfer function */
