...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_dbk;  /**< do we need source for delta of dark matter with effective interactions? */
  ...
  short has_source_theta_dbk;  /**< do we need source for theta of dark matter with effective interactions? */
  ...
  int index_tp_delta_dbk;  /**< index value for delta of dark matter with effective interactions */
  ...
  int index_tp_theta_dbk;   /**< index value for theta of dark matter with effective interactions */
...
struct perturb_vector
{
  ...
  int index_pt_delta_dbk;   /**< dbk density */
  int index_pt_theta_dbk;   /**< dbk velocity */
