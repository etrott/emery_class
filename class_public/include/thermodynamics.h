...
struct thermo
{
  ...
  double dmeff_sigma_p; /* dmeff scattering cross section with protons */

  short use_helium_dmeff; /** Flag to include interactions with helium or not. */

  short use_temperature_dmeff; /** Flag to include temperature evolution of dmeff or not. */
...
struct dmeff_thermo {
  ...
  /**< Indices for response functions */
  int size_resp; /**< number of response indices */
  int index_M;
  int index_Ppp;
  int index_PppM;
  int index_tPp;
  ...
  /**< Indices for baryonic elements. */
  int size_elem; /**< number of element indices */
  int index_H1;
  int index_He4;

  /**< Indices for saved quantities in R_table */
  int size_R_type; /**< number of type indices */
  int index_R_op1; /**< operator 1 */
  int index_R_op2; /**< operator 2 */
  int index_R_vp2; /**< powers of v_perp^2 */
  int index_R_qm2; /**< powers of (q/mN)^2 */

  /**< Indices for saved quantities in W_table */
  int size_W_type;  /**< number of type indices */
  int index_W_iso1; /**< isospin 1 */
  int index_W_iso2; /**< isospin 2 */
  int index_W_ypow; /**< powers of y */
  int index_W_resp; /**< response function */

  /**< Number of entries (rows) in files for W and R. */
  int *size_W; /**< size_W[index_elem] */
  int *size_R; /**< size_R[index_resp] */

  /**< Response functions. */
  double **R; /**< R[index_resp][index_R] */
  double **W; /**< W[index_elem][index_W] */

  /**< R_table[index_resp][index_R * size_R_type + index_R_type] */
  int **R_table;

  /**< W_table[index_elem][index_W * size_W_type + index_W_type] */
  int **W_table;

  /**< Cross sections. */
  int *size_sig; /**< size_sig[index_elem] */
  int **sig_v2;    /**< sig_v2[index_elem][index_sig] */
  int **sig_vperp2;/**< sig_vperp2[index_elem][index_sig] */
  double **sig;    /**< sig[index_elem][index_sig] */
  double sigma_p;  /**< actual cross section with proton */

  /**< Properties for baryonic elements. */
  double *bmuT;  /**< bmuT[index_elem] */
  double *mass;  /**< mass[index_elem] */
  double *spin;  /**< spin[index_elem] */
  double *frac;  /**< frac[index_elem] */

  /**< Coupling coefficients */
  int size_cc; /**< number of distinct powers of (q/mN)^2 */
  int *cc_qm2; /**< powers of (q/mN)^2, cc_qm2[index_cc] */
  double *cc;  /**< cc[(index_cc * _OP_DMEFF_ + index_op) * 2 + index_iso] */
  ...
  /* Flag to indicate there are nonzero interactions. */
  short has_nonzero;
...
extern "C" {
  ...
  int dmeff_get_response(struct dmeff_thermo *pdmeff,
                         char *name,
                         int *index);
