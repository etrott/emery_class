...
struct background
{
  ...
  double Omega0_dbk; /**< \f$ \Omega_{0 dbk} \f$ : dark matter with effective interactions */

  double Omega0_dmeff; /**< \f$ \Omega_{0 dmeff} \f$ : dark matter with effective interactions */

  double m_dbk; /**< \f$ \m_{dbk} \f$ : mass of dark matter with effective interactions */

  double npow_dbk; /**< \f$ \n_{dbk} \f$ : power of velocity of cross section for dark matter
			with effective interactions with protons */

  double sigM_dbk; /**< \f$ \simga_{dbk}/m_{dbk} \f$ : cross section over mass of dark matter with effective interactions, in units of cm^2/g */
  ...
  double cc_dmeff_scale; /**< Overall scale of dmeff coupling coefficients */
  int cc_dmeff_num; /**< Number of input dmeff coupling coefficients */
  int *cc_dmeff_op; /**< Label of corresponding operator */
  int *cc_dmeff_qm2;/**< Powers of (q/m_N)^2 muliplying the couplings */
  double *cc_dmeff_p; /**< Coupling coefficient to protons */
  double *cc_dmeff_n; /**< Coupling coefficient to neutrons */
  ...
  int index_bg_rho_dbk;       /**< dbk density */
  int index_bg_rho_dmeff;     /**< dmeff density */

  int index_bg_Tdbk;          /**< dbk temperature */
  int index_bg_dkappa_dbk;    /**< dbk dkappa/dtau */
  int index_bg_cdbk2;         /**< dbk speed of sound squared */
  ...
  short has_dbk;       /**< presence of dark matter with effective interactions? */
  ...
  /**
   *@name - arrays related to dbk
   */


  //@{

  double z_dbk_decoupling; /* redshift at which Tdbk transitions from scaling as (1+z) to scaling as (1+z)^2*/
...
#define _OP_DMEFF_ 15 /** Number of dmeff operators */
